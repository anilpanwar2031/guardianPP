...
def get_details(file_path, texts, eobclaimmaster):
    ...
    for obj in ls:
        ...
        new_dict.update({'ProcCode': proccode, 'Description': description, 'PatientResp': '', 'Adjustments': '',
                         'OtherAdjustments': '',
                         'Enrollee_ClaimID': '', 'PPGridViewId': '', 'RemarkCodes': '',
